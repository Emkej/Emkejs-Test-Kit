...
MyGUI::TextBox* g_itemQualityLabelText = 0;
MyGUI::ComboBox* g_itemQualityDropdown = 0;
...
MyGUI::TextBox* g_spawnFactionLabelText = 0;
MyGUI::ComboBox* g_spawnFactionDropdown = 0;
MyGUI::TextBox* g_spawnCustomFactionLabelText = 0;
MyGUI::EditBox* g_spawnCustomFactionSearchEdit = 0;
MyGUI::ListBox* g_spawnCustomFactionResultsList = 0;
